    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatsCard
          ...
          change={`${reportsData.stats.successRate}% successful`}
          isPositive={true}
        />
        <StatsCard
          title="Avg. Consultations/Day"
          value={reportsData.stats.avgPerDay}
          change={`Based on ${Math.round(reportsData.stats.totalConsultations / reportsData.stats.avgPerDay || 1)} days`}
          isPositive={true}
        />
        <StatsCard
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <ConsultationsTrend trendData={reportsData.trend} />
        <ConsultationStatus statusData={reportsData.status} />
      </div>

      {/* Pathologies Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <CommonPathologies pathologies={reportsData.pathologies} />
        <PathologiesByCount pathologies={reportsData.pathologiesByCount} />
      </div>
    </div>
  );
}
