...
function initDatabase() {
  ...
  // Test override: allow forcing a specific DB file path (so tests don't touch real data)
...
module.exports = {
  ...
  getDatabase,
  closeDatabase,
  // Test-only: reset module state between tests (DB file is not deleted automatically).
  __resetForTests: () => {
    try {
      closeDatabase();
    } finally {
