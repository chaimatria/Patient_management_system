...
async function sendPasswordResetEmail(email, resetToken, resetUrl) {
  try {
    ...
    if (!process.env.SMTP_USER || !process.env.SMTP_PASS) {
      ...
      console.log('⚠️  To enable email, create .env.local file with SMTP_USER and SMTP_PASS');
      return { 
        success: false, 
        configured: false,
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="warning">
                <strong>⚠️ Security Notice:</strong> This link will expire in 1 hour. If you did not request this password reset, please ignore this email.
              </div>
